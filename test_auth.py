...
class TestAuth:
    def test_auth(self):
        ...
        assert "auth_sid" in response1.cookies, "There in no auth cookie in the response"
        ...
        assert user_id_from_auth_method == user_id_from_chek_method, "User id from auth method is not equl to user id from check method"